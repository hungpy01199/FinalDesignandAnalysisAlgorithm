...
public class Main implements ActionListener {
	...
	private JLabel lblkT = new JLabel("KNIGHT TOUR");
	...
	Main (){
		mainDialog = new JFrame("Knight Tour");
		...
		SpinnerNumberModel limit = new SpinnerNumberModel(3,1,40,1);  
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(rbWD.isSelected()) {
			new KnightTour_Warnsdorf(boardSize);
		}	
		else if(rbBT.isSelected()) {
			new KnightTour_Backtracking(boardSize);
		}
	}
